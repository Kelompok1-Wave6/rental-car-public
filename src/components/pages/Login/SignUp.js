...
import Signupkanan from '../../asset/Login/LogoKanan.png';
import Logoregister from '../../asset/Login/LogoKiri.png';
import './Login.css';
              ...
              <div className="signup-konten">
                ...
                <Form onSubmit={handleSubmit}>
                  <Form.Group className="mb-3 name" controlId="formBasicName">
                    ...
                    <Form.Control value={name} type="text" placeholder="Nama Lengkap"
